...
Императивное программирование фокусируется на том, __КАК__ выполнять логику программы, и определяет поток управления как инструкции, которые изменяют состояние программы.  
Это можно дополнительно классифицировать как:
а) Парадигма процедурного программирования. Процедурное программирование определяет шаги, которые программа должна предпринять для достижения желаемого состояния, обычно читаемые в порядке сверху вниз. (Языки: C, Pascal, COBOL, ALGOL, BASIC, Fortran)
б) Объектно-ориентированное программирование или ООП. Организует программы как объекты, которые содержат некоторые данные (переменные - состояние) и имеют определенное поведение (методы). (Языки: Java, C++, C#, Python, PHP, JavaScript, Ruby, Perl)
в) Параллельное программирование. Парадигма параллельного программирования разбивает задачу на подзадачи и фокусируется на их одновременном выполнении. (Языки: Java, Go, C#, Rust)

Декларативное программирование фокусируется на том, __ЧТО__ выполнять, и определяет логику программы, но не подробный поток управления. Декларативная парадигма может быть подразделена на:

а) Парадигма логического программирования. Парадигма логического программирования основана на формальной логике, которая относится к набору предложений, выражающих факты и правила о том, как решить проблему. (Языки: Parlog, Prolog)

б) Парадигма функционального программирования. Функциональное программирование — это парадигма программирования, в которой программы создаются путем применения и составления функций. (Языки: Haskell, Clojure, Erlang, Elixir)

в) Парадигма программирования базы данных: модель программирования базы данных используется для управления данными и информацией, структурированной в виде полей, записей и файлов. (SQL)
